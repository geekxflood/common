...
// hardcoded logic. It provides CUE-based schema validation, hot reload
// capabilities, and type-safe configuration access.
//
// # Basic Usage
//
...
//
// SchemaLoader handles loading CUE schema files from the filesystem,
// validating them, and providing schema information for validation and
...
type Options struct {
	...
	// This field is required and must point to a valid CUE schema file.
	SchemaPath string
...
func NewManager(options Options) (Manager, error) {
	...
	// Load configuration
	if err := configLoader.LoadConfig(options.ConfigPath); err != nil {
...
func (m *configManager) StartHotReload(ctx context.Context) error {
	...
	hotReloader, err := newHotReloader(m.options.ConfigPath, m.options.SchemaPath, reloadCallback)
	if err != nil {
